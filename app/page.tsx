        ...
        <section className="container-custom py-section md:py-container">
          <div className="max-w-4xl">
            ...
            <p className="text-body-large text-muted max-w-content mb-12">
              Managing digital products and cross-functional teams across 15
              European markets. Specialized in e-commerce, API integrations, and
        ...
        <FadeIn>
          ...
          >
            ...
            <div className="mt-12 text-center">
              <a
                href="/projects"
                className="inline-flex items-center text-body-large font-semibold hover:gap-2 transition-all group"
              >
                View All Projects
            ...
            <div className="max-w-4xl">
              ...
              <div className="space-y-8 max-w-3xl">
                <p className="text-body-large text-foreground">
                  I'm a Project Manager who bridges technical execution and
                ...
                <div className="pt-8 border-t border-border">
                  <p className="text-heading-3 mb-6">
                    I'm the Project Manager who can sit with engineers to debug
                    an API integration in the morning, then present business
          ...
          >
            <div className="max-w-4xl">
              ...
              <p className="text-heading-3 text-muted mb-16 max-w-3xl">
                I'm currently interested in Project Manager roles where I can
