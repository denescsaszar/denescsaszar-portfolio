      ...
      <section className="container-custom py-section md:py-container">
        <div className="max-w-4xl">
          ...
          <div className="flex gap-6">
            <a
              href="#projects"
              className="inline-block px-8 py-4 bg-foreground text-background hover:bg-muted transition-colors"
            >
              View Projects
            </a>
            <a
              href="#contact"
              className="inline-block px-8 py-4 border border-foreground hover:bg-foreground hover:text-background transition-colors"
            >
              Get in Touch
            </a>
          </div>
