  ...
  return (
    <>
      <nav
        className={
          isScrolled
            ? "fixed top-0 left-0 right-0 z-50 bg-background border-b border-border shadow-sm transition-all"
            : "fixed top-0 left-0 right-0 z-50 bg-transparent transition-all"
        }
      >
